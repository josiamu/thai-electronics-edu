...
├── breadboard.html     — ทดลองบนเบรดบอร์ด (400-point): เลือก/วางอุปกรณ์ R (คงที่/VR/NTC/PTC/LDR/VDR)/ไดโอด+LED (ซิลิคอน/เจอร์เมเนียม/ชอตต์กี/ซีเนอร์/LED รวมเป็น list เดียว)/จัมเปอร์/สวิตช์/แบตเตอรี่/ตัวเก็บประจุ/ตัวเหนี่ยวนำ/ทรานซิสเตอร์ (NPN/PNP/N-MOSFET/P-MOSFET — วาง 3 ขา)/โพเทนชิโอมิเตอร์ 3 ขา (แบ่งแรงดัน) เอง, มัลติมิเตอร์เสมือน (V/I/Ω/diode-test/continuity), แผงสภาพแวดล้อม (อุณหภูมิ/แสง/VR knob), แผง Transient (กราฟ V/I ตามเวลา + speed + restart + τ), คลิกแก้ไข + ลาก-ย้ายอุปกรณ์, คำนวณวงจรจริง (MNA + transient + ทรานซิสเตอร์ Cut-off/Active/Saturation), LED ติด/ดับ, electron animation, บันทึก/โหลดวงจร (localStorage) + แชร์ลิงก์ (URL `?c=`)
